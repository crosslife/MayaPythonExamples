...
# DESCRIPTION:
#
# This example demonstrates how to use the "MPx3dModelView" and "MPxModelEditorCommand"
# classes to implement a viewer. The viewer will highlight narrow polygons and
# must be given a geometry that is triangulated.
#
# To use this example, do the following:
#
#	(1) Load the plug-in.
#	(2) Create the mesh geometry and triangulate it.
#	(3) Select the mesh geometry.
#	(4) Execute the script showNarrowPolyViewer.py.
#	(5) Manipulate a vertex to create a narrow polygon.
#		Narrow polygons will be shaded as defined by the tolerance set in the plug-in.
#
########################################################################
